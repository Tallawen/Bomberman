...
int main() {
	...
	Sprite::instance()->insertTexture("Data/About_Description.png");
	Sprite::instance()->insertTexture("Data/About_GoodLuck.png");
	...
	Sprite::instance()->insertSprite("About_Description", "About_Description", 352, 89, 0, 0);
	Sprite::instance()->insertSprite("About_GoodLuck",    "About_GoodLuck", 121, 71, 0, 0);
	...
	while(!done) {
		...
		if(id == 1) {
			Window::instance()->init(1227, 720, "Bomberman");
			game.startGame(0);
		}
